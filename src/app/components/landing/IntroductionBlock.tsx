...
export const IntroductionBlock = async () => {
  ...
  return (
    <div className="text-center mt-[50px] mb-6">
      <h1
        className={`${fadeIn} flex justify-center items-center text-[32px] font-bold sm:text-[48px] mx-auto text-orange-500`}
      >
        <TypingAnimation />
        <span className="ml-1 mt-[-4px] h-[37px] w-[3px] animate-blink bg-[#CD202A] opacity-60"></span>
        <span className="ml-2 text-white">K157</span>
      </h1>
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 text-white">
        {t.rich("main_title", {
          highlight: (chunks) => (
